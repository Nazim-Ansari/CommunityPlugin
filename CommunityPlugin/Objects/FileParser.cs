using SharkeyByte.Objects.Enums;
using SharkeyByte.Objects.Models.Translation;
...
namespace SharkeyByte.Objects.Helpers
{
    public class FileParser
    {
        ...
        public static DataTable DataTableFromReport(List<string[]> Data)
        {
            DataTable dt = new DataTable();
            string[] Fields  = Data[0].Select(x => x).ToArray();
